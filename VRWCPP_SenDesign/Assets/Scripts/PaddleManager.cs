...
public class PaddleManager : MonoBehaviour
{
    ...
    private void OnRightSelectPerformed(InputAction.CallbackContext context)
    {
        if (!isLeftPaddleActive)
        {
            ...
            // Add OutOfBoundsHandler component to the ball
            if (!spawnedball.GetComponent<OutOfBoundsHandler>())
            {
                spawnedball.AddComponent<OutOfBoundsHandler>();
            }
